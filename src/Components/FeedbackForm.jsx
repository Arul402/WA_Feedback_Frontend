...
function FeedbackForm() {
    ...
    async function handleFeedbackSubmit() {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/v1/app/feedback/', data, {
                headers: {
      ...
      {[1, 2, 3, 4, 5].map((star) => (
        ...
        >
          {star <= rating ? <FaStar /> : <FaRegStar />}
                            ...
                            <div className="inputBox">
                                <input type="submit" value="Submit Feedback" onClick={(e) => { e.preventDefault(); handleFeedbackSubmit(); }} />
                            </div>
                        </div>
                    </div>
                </div>
